...
@section('title')Подтвердить пароль@endsection
@section('description')Подтвердить пароль@endsection
...
@section('content')
    <div class="nk-block nk-block-middle nk-auth-body">
        ...
        <form action="{{ route('password.confirm') }}" class="form-validate is-alter" method="post">
            @csrf
            ...
            <div class="form-group">
                <button class="btn btn-lg btn-primary btn-block">Подтвердить пароль</button>
            </div>
        </form><!-- form -->

                ...
                <div class="nk-tb-list nk-tb-ulist">
                    ...
                    @foreach($brands as $brand)
                        <div class="nk-tb-item">
                            <div class="nk-tb-col">
                                <a href="{{ route('admin.brands.edit', $brand) }}"><span class="fw-medium">{{ $brand->name }}</span></a>
                            </div>
                            <div class="nk-tb-col">
                                <span class="fw-medium">{{ $brand->rating_value_format }}</span>
                            </div>
                            <div class="nk-tb-col tb-col-sm"><span>{{ $brand->reviews_count }}</span></div>

                            <div class="nk-tb-col nk-tb-col-tools">
                                <ul class="nk-tb-actions gx-1">
                                    <li class="nk-tb-action-hidden">
                                        <a href="{{ route('admin.brands.edit', $brand) }}" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Редактировать"><em class="icon ni ni-edit-fill"></em></a>
                                    </li>
                                    <li class="nk-tb-action-hidden">
                                        <a href="{{ route('brands.reviews', $brand) }}" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Посмотреть на сайте" target="_blank"><em class="icon ni ni-eye-fill"></em></a>
                                    </li>
                                    <li class="nk-tb-action-hidden">
